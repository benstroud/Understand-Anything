...
```astro
---
const githubUrl = 'https://github.com/benstroud/Understand-Anything';
---
...
<section class="install" id="install">
  <div class="install-inner reveal">
    ...
    <div class="install-code">
      ...
      <pre><code><span class="cmd">/plugin marketplace add</span> benstroud/Understand-Anything
...
```markdown
**[Homepage](https://understand-anything.com)** | **[GitHub](https://github.com/benstroud/Understand-Anything)**
```
