...
```
Fetch and follow instructions from https://raw.githubusercontent.com/benstroud/Understand-Anything/refs/heads/main/understand-anything-plugin/.codex/INSTALL.md
```
